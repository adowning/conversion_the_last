        ...
        try {
            ...
            switch (aid) {
                ...
                case 'spin':
                    ...
                    linesId[8] = [1, 1, 2, 3, 3];
                    linesId[9] = [1, 1, 2, 3, 4];
                    linesId[10] = [1, 2, 2, 1, 1];
                    linesId[11] = [1, 2, 2, 1, 2];
                    linesId[12] = [1, 2, 2, 2, 2];
                    linesId[13] = [1, 2, 2, 2, 3];
                    linesId[14] = [1, 2, 2, 3, 3];
                    linesId[15] = [1, 2, 2, 3, 4];
                    linesId[16] = [1, 2, 3, 2, 2];
                    linesId[17] = [1, 2, 3, 2, 3];
                    linesId[18] = [1, 2, 3, 3, 3];
                    linesId[19] = [1, 2, 3, 3, 4];
                    linesId[20] = [1, 2, 3, 4, 4];
                    linesId[21] = [1, 2, 3, 4, 5];
                    linesId[22] = [2, 1, 1, 1, 1];
                    linesId[23] = [2, 1, 1, 1, 2];
                    linesId[24] = [2, 1, 1, 2, 2];
                    linesId[25] = [2, 1, 1, 2, 3];
                    linesId[26] = [2, 1, 2, 1, 1];
                    linesId[27] = [2, 1, 2, 1, 2];
                    linesId[28] = [2, 1, 2, 2, 2];
                    linesId[29] = [2, 1, 2, 2, 3];
                    linesId[30] = [2, 1, 2, 3, 3];
                    linesId[31] = [2, 1, 2, 3, 4];
                    linesId[32] = [2, 2, 2, 1, 1];
                    linesId[33] = [2, 2, 2, 1, 2];
                    linesId[34] = [2, 2, 2, 2, 2];
                    linesId[35] = [2, 2, 2, 2, 3];
                    linesId[36] = [2, 2, 2, 3, 3];
                    linesId[37] = [2, 2, 2, 3, 4];
                    linesId[38] = [2, 2, 3, 2, 2];
                    linesId[39] = [2, 2, 3, 2, 3];
                    linesId[40] = [2, 2, 3, 3, 3];
                    linesId[41] = [2, 2, 3, 3, 4];
                    linesId[42] = [2, 2, 3, 4, 4];
                    linesId[43] = [2, 2, 3, 4, 5];
                    linesId[44] = [2, 3, 3, 2, 2];
                    linesId[45] = [2, 3, 3, 2, 3];
                    linesId[46] = [2, 3, 3, 3, 3];
                    linesId[47] = [2, 3, 3, 3, 4];
                    linesId[48] = [2, 3, 3, 4, 4];
                    linesId[49] = [2, 3, 3, 4, 5];
                    linesId[50] = [2, 3, 4, 3, 3];
                    linesId[51] = [2, 3, 4, 3, 4];
                    linesId[52] = [2, 3, 4, 4, 4];
                    linesId[53] = [2, 3, 4, 4, 5];
                    linesId[54] = [3, 2, 2, 1, 1];
                    linesId[55] = [3, 2, 2, 1, 2];
                    linesId[56] = [3, 2, 2, 2, 2];
                    linesId[57] = [3, 2, 2, 2, 3];
                    linesId[58] = [3, 2, 2, 3, 3];
                    linesId[59] = [3, 2, 2, 3, 4];
                    linesId[60] = [3, 2, 3, 2, 2];
                    linesId[61] = [3, 2, 3, 2, 3];
                    linesId[62] = [3, 2, 3, 3, 3];
                    linesId[63] = [3, 2, 3, 3, 4];
                    linesId[64] = [3, 2, 3, 4, 4];
                    linesId[65] = [3, 2, 3, 4, 5];
                    linesId[66] = [3, 3, 3, 2, 2];
                    linesId[67] = [3, 3, 3, 2, 3];
                    linesId[68] = [3, 3, 3, 3, 3];
                    linesId[69] = [3, 3, 3, 3, 4];
                    linesId[70] = [3, 3, 3, 4, 4];
                    linesId[71] = [3, 3, 3, 4, 5];
                    linesId[72] = [3, 3, 4, 3, 3];
                    linesId[73] = [3, 3, 4, 3, 4];
                    linesId[74] = [3, 3, 4, 4, 4];
                    linesId[75] = [3, 3, 4, 4, 5];
                    ...
                    if (postData['slotEvent'] != 'freespin') {
                        ...
                        slotSettings.SetGameData('FortuneRangersNETFreeBalance', Number(slotSettings.GetBalance().toFixed(2)) * 100);
                        bonusMpl = 1;
                    } else {
                    ...
                    for (let i = 0; i <= 2000; i++) {
                        ...
                        for (let k = 0; k < 76; k++) {
                            ...
                            for (let j = 0; j < (slotSettings.SymbolGame?.length || 0); j++) {
                                ...
                                if (csym == scatter || !slotSettings.Paytable['SYM_' + csym]) {
                                    ...
                                    if ((s[0] == csym || is_wild(s[0])) && (s[1] == csym || is_wild(s[1])) && (s[2] == csym || is_wild(s[2])) && (s[3] == csym || is_wild(s[3]))) {
                                        let mpl = 1;
                                        if (is_wild(s[0]) && is_wild(s[1]) && is_wild(s[2]) && is_wild(s[3])) {
                                            mpl = 1;
                                        } else if (is_wild(s[0]) || is_wild(s[1]) || is_wild(s[2]) || is_wild(s[3])) {
                                            mpl = slotSettings.slotWildMpl || 1;
                                        }
                                    ...
                                    if ((s[0] == csym || is_wild(s[0])) && (s[1] == csym || is_wild(s[1])) && (s[2] == csym || is_wild(s[2])) && (s[3] == csym || is_wild(s[3])) && (s[4] == csym || is_wild(s[4]))) {
                                        let mpl = 1;
                                        if (is_wild(s[0]) && is_wild(s[1]) && is_wild(s[2]) && is_wild(s[3]) && is_wild(s[4])) {
                                            mpl = 1;
                                        } else if (is_wild(s[0]) || is_wild(s[1]) || is_wild(s[2]) || is_wild(s[3]) || is_wild(s[4])) {
                                            mpl = slotSettings.slotWildMpl || 1;
                                        }
                        ...
                        if (scattersCount >= 3) {
                            // Freespins trigger logic would construct string here if needed inside loop, but usually it's post-loop
                        }
                    ...
                    if (postData['slotEvent'] == 'freespin') {
                        ...
                        const fs = slotSettings.GetGameData('FortuneRangersNETFreeGames');
                        const fsl = slotSettings.GetGameData('FortuneRangersNETFreeGames') - slotSettings.GetGameData('FortuneRangersNETCurrentFreeGame');
                    ...
                    const response = '{"responseEvent":"spin","responseType":"' + postData['slotEvent'] + '","serverResponse":{"freeState":"' + freeState + '","slotLines":' + lines + ',"slotBet":' + betline + ',"totalFreeGames":' + slotSettings.GetGameData('FortuneRangersNETFreeGames') + ',"currentFreeGames":' + slotSettings.GetGameData('FortuneRangersNETCurrentFreeGame') + ',"Balance":' + balanceInCents + ',"afterBalance":' + balanceInCents + ',"bonusWin":' + slotSettings.GetGameData('FortuneRangersNETBonusWin') + ',"totalWin":' + totalWin + ',"winLines":[],"Jackpots":' + jsJack + ',"reelsSymbols":' + jsSpin + '}}';
