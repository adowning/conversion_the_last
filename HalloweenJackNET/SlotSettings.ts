...
export class SlotSettings {
    ...
    constructor(sid: string, playerId: number, context: IContext) {
        ...
        this.reelStripBonus2 = [12,8,10,9,11,7,8,5,9,10,12,11,3,6,5,9,10,12,11,4,3,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,7,8,11,3,5,9,4,6,3,8,7,9,6,4,5,11,7,8,5,9,10,12,11,3,6,5,9,10,12,11,4,3,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,7,8,11,3,5,9];
        this.reelStripBonus3 = [12,8,10,9,11,7,8,11,7,8,5,9,10,12,11,3,6,5,9,10,12,11,4,3,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,7,8,11,3,9,10,12,11,4,0,3,8,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,5,9,5,9,10,12,11,3,6,5,9,10,12,11,4,3,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,7,8,11,3,5,9,4,6,3,8,7,9,6,4,5];
        this.reelStripBonus4 = [12,8,10,9,11,7,8,5,9,10,12,11,3,6,5,9,10,12,11,4,3,7,9,4,7,3,9,8,10,11,5,7,12,9,11,7,8,5,9,10,12,9,10,12,11,4,0,3,8,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,11,3,6,5,9,10,12,11,4,3,7,9,4,7,3,9,8,10,11,5,7,12,9,6,8,10,5,3,8,9,12,3,7,8,11,3,5,9,6,8,10,5,3,8,9,12,3,7,8,11,3,5,9,4,6,3,8,7,9,6,4,5];
    ...
    public GetReelStrips(winType: any, slotEvent: any) {
        if (slotEvent == 'freespin') {
            // Emulate replacement of strips with bonus strips
            // In PHP: array_shift($fArr) -> gets next bonus strip for each iteration
            // Since I embedded bonus strips, I can just assign them
            // But wait, PHP logic:
            // $fArr = $reel->reelsStripBonus; (Array of arrays 1-6)
            // Loop 1-6. curReel = array_shift($fArr).
            // So: reelStrip1 = reelsStripBonus[0], reelStrip2 = reelsStripBonus[1]...
            // Note: reelsStripBonus in PHP is associative if I populated it that way, but array_shift works on array structure.
            // If I defined them as properties, I can map them.
