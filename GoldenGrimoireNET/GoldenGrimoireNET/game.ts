...
export class Game extends StatelessModel {
  ...
  // Explicit Getters for SlotSettings
  get denomination() {
    return Number(this.getAttribute("denomination"));
  }
  get slotViewState() {
    return this.getAttribute("slotViewState");
  }
  get jp_1() {
    return this.getAttribute("jp_1");
  }
  get jp_1_percent() {
    return this.getAttribute("jp_1_percent");
  }
  get jp_2() {
    return this.getAttribute("jp_2");
  }
  get jp_2_percent() {
    return this.getAttribute("jp_2_percent");
  }
  get jp_3() {
    return this.getAttribute("jp_3");
  }
  get jp_3_percent() {
    return this.getAttribute("jp_3_percent");
  }
  get jp_4() {
    return this.getAttribute("jp_4");
  }
  get jp_4_percent() {
    return this.getAttribute("jp_4_percent");
  }
  get bet() {
    return this.getAttribute("bet");
  }
  get rezerv() {
    return this.getAttribute("rezerv");
  }
  get id() {
  ...
  get stat_out() {
    return Number(this.getAttribute("stat_out"));
  }
  get name() {
