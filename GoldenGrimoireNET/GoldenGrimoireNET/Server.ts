...
export class Server {
    public get(request: any, context: IContext): string {
        try {
            ...
            switch (aid) {
                case 'init':
                    curReels = '&rs.i0.r.i0.syms=SYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '' + '%2CSYM' + PhpHelpers.rand(1, 7) + '';
                    curReels += ('&rs.i0.r.i1.syms=SYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '' + '%2CSYM' + PhpHelpers.rand(1, 7) + '');
                    ...
                    curReels += ('&rs.i0.r.i4.syms=SYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '%2CSYM' + PhpHelpers.rand(1, 7) + '' + '%2CSYM' + PhpHelpers.rand(1, 7) + '');
                ...
                case 'spin':
                    ...
                    for (let i = 0; i <= 2000; i++) {
                        ...
                        // Shuffle
                        for (let k = overlayRandomSymArr.length - 1; k > 0; k--) {
                            const j = Math.floor(Math.random() * (k + 1));
                            [overlayRandomSymArr[k], overlayRandomSymArr[j]] = [overlayRandomSymArr[j], overlayRandomSymArr[k]];
                        }
