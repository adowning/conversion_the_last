            ...
            switch (aid) {
                ...
                case 'spin':
                    ...
                    if (postData['slotEvent'] != 'freespin') {
                        ...
                        slotSettings.SetGameData('GoBananasNETFreeBalance', (slotSettings.GetBalance() * 100).toFixed(2));
                        bonusMpl = 1;
                    } else {
                    ...
                    for (let i = 0; i <= 2000; i++) {
                        ...
                        tmpReels = JSON.parse(JSON.stringify(reels)); // Deep copy for tmpReels
                        wildStr = '';
                        wcnt = 0;
                        p00A = [0, 0, 0, 0, 0, 0, 0];
                    ...
                    if (postData['slotEvent'] == 'freespin') {
                        ...
                        fs = slotSettings.GetGameData('GoBananasNETFreeGames');
                        let fsl = slotSettings.GetGameData('GoBananasNETFreeGames') - slotSettings.GetGameData('GoBananasNETCurrentFreeGame');
