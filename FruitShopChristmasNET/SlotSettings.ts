...
export class SlotSettings {
    ...
    public reelStripBonus1: any = null;
    public reelStripBonus2: any = null;
    public reelStripBonus3: any = null;
    public reelStripBonus4: any = null;
    public reelStripBonus5: any = null;
    public reelStripBonus6: any = null;
    ...
    constructor(sid: string, playerId: number, context: IContext) {
        ...
        // Manual population of reel strips from reels.txt
        this.reelStrip1 = [10, 6, 11, 8, 5, 9, 12, 7, 7, 3, 12, 4, 9, 10, 6, 11, 8, 5, 11, 12, 7, 10, 3, 11, 7, 12, 4, 12, 6, 7, 3, 11, 8, 5, 6, 12, 9, 8, 12, 4, 9];
        this.reelStrip2 = [10, 3, 1, 12, 11, 5, 9, 5, 10, 11, 8, 4, 11, 5, 10, 6, 9, 11, 6, 8, 9, 3, 12, 11, 5, 9, 12, 7, 11, 8, 4, 12, 7, 10, 3, 12, 4, 11, 1, 9, 11, 6, 9];
        ...
        this.reelStrip4 = [12, 3, 9, 4, 8, 3, 11, 12, 6, 9, 7, 10, 3, 9, 11, 6, 8, 10, 5, 12, 4, 10, 7, 9, 8, 11, 10, 12, 5, 9, 8, 3, 11, 7, 6, 9, 7, 10, 9, 7, 8, 6, 9, 8, 6, 10, 12, 11, 5, 8, 9, 12, 11, 6, 12, 10, 11, 10, 5, 12, 9, 11, 7, 8, 11, 10, 12, 1, 10, 8, 4, 11];
        this.reelStrip5 = [9, 5, 10, 12, 4, 8, 9, 6, 11, 12, 5, 8, 10, 3, 9, 11, 6, 10, 12, 7, 11, 9, 11, 7, 8, 9, 3, 10, 12, 4, 8, 9, 6, 11, 12, 5, 8, 10, 5, 9, 11, 3, 10, 12, 7, 11, 12, 4, 11, 12, 8, 4, 11, 12, 4, 10, 9, 10, 3, 9, 8, 5, 12, 6, 8, 5, 12, 6, 9, 10, 7, 11, 10, 7, 8];
        this.reelStrip6 = [];
    ...
    public GetReelStrips(winType: any, slotEvent: any) {
        ...
        for (const index in prs) {
            ...
            // key[-1] = key[cnt - 1]; // Cannot set negative index on array easily in JS without Proxy
            // key[cnt] = key[0];
            ...
            // Emulate key[-1] access using modulo or explicit check
            let val0;
            if (value - 1 < 0) {
