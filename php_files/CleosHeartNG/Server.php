                    ...
                    try
                    {
                        ...
                        switch( $reqId ) 
                        {
                            ...
                            case 'SpinRequest':
                                ...
                                $lines = 10;
                                $betLine = $postData['data']['coin'] * (int)$postData['data']['bet'];
                                ...
                                {
                                    $winString = ',"slotWin":{"lineWinAmounts":[' . implode(',', $lineWins) . '],"totalWin":"' . $slotSettings->FormatFloat($totalWin) . '","canGamble":"false"}';
                                }
                                else
                                {
                                    $winString = '';
