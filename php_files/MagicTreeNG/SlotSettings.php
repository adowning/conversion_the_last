<?php
namespace App\Games\MagicTreeNG
{
    class SlotSettings
    {
        ...
        public function GetRandomScatterPos($rp, $bs, $bs0)
        {
            $rpResult = [];
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                {
                    if( ($i == 0 || $i == 2 || $i == 4) && $rbs == 1 )
                    {
                        $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, 11, 11);
                    }
                    else if( ($i == 1 || $i == 2 || $i == 3) && $rbs == 2 )
                    {
                        $prs[$reelsId[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $reelsId[$i]}, 13, 13);
                    }
                    else
                    {
