                        ...
                        switch( $reqId ) 
                        {
                            ...
                            case 'SpinRequest':
                                ...
                                if( $totalWin > 0 ) 
                                {
                                    ...
                                    {
                                        $winString = ',"slotWin":{"lineWinAmounts":[' . $winString0 . ']' . $expWinStr . ',"totalWin":"' . $slotSettings->FormatFloat($totalWin) . '","canGamble":"true","gambleParams":{"history":["0","1","1","0","1"]}}';
                                    }
                                    else
                                    {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    $result_tmp[0] = '{"action":"BonusGameResponse","result":"true","sesId":"10000228087","data":{"state":"FreeSpins"' . $winString . $expSpinStr . ',"spinResult":{"type":"SpinResult","rows":[' . $symb . ']},"totalBonusWin":"8000","freeSpinRemain":"' . $freeSpinRemain . '","freeSpinsTotal":"' . $freeSpinsTotal . '","expandingSymbol":"' . $ExpandingSymbols[0] . '","params":""}}';
                                }
                                else
                                {
                            ...
                            case 'GambleRequest':
                                ...
                                $result_tmp[0] = '{"action":"GambleResponse","result":"true","sesId":"10001363468","data":{"winning":"' . $totalWin . '","canGamble":"' . $gambleState . '"}}';
                                break;
                        }
