                    ...
                    try
                    {
                        ...
                        switch( $reqId ) 
                        {
                            ...
                            case 'PickBonusItemRequest':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $allbet * $curMpl <= $bank ) 
                                    {
                                        ...
                                        if( $curMpl == 1 ) 
                                        {
                                            ...
                                            $params = '{"freeSpins":"12","freeSpinsTotal":"12"}';
                                            $state = 'FreeSpins';
                                        }
                                        break;
                                    }
                                ...
                                $slotSettings->SaveLogReport('NULL', 0, 0, $win, 'BG');
